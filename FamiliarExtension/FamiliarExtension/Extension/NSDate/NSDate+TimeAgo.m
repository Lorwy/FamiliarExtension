...
#define kNSLocalizedStringDefine(key) NSLocalizedString(key,@"")
...
- (NSString *)timeAgo
{
    ...
    if(deltaSeconds < 5)
    {
        return kNSLocalizedStringDefine(@"Just now");
    }
    ...
    {
        return kNSLocalizedStringDefine(@"A minute ago");
    }
    else if (deltaMinutes < 60)
    {
    ...
    {
        return kNSLocalizedStringDefine(@"An hour ago");
    }
    else if (deltaMinutes < (24 * 60))
    {
    ...
    {
        return kNSLocalizedStringDefine(@"Yesterday");
    }
    else if (deltaMinutes < (24 * 60 * 7))
    {
    ...
    {
        return kNSLocalizedStringDefine(@"Last week");
    }
    else if (deltaMinutes < (24 * 60 * 31))
    {
    ...
    {
        return kNSLocalizedStringDefine(@"Last month");
    }
    else if (deltaMinutes < (24 * 60 * 365.25))
    {
    ...
    {
        return kNSLocalizedStringDefine(@"Last year");
    }
...
- (NSString *)dateTimeAgo
{
    ...
    if (components.year >= 1)
    {
        if (components.year == 1)
        {
            return kNSLocalizedStringDefine(@"1 year ago");
        }
    ...
    else if (components.month >= 1)
    {
        ...
        {
            return kNSLocalizedStringDefine(@"1 month ago");
        }
    ...
    else if (components.weekOfYear >= 1)
    {
        ...
        {
            return kNSLocalizedStringDefine(@"1 week ago");
        }
    ...
    else if (components.day >= 1)    // up to 6 days ago
    {
        if (components.day == 1)
        {
            return kNSLocalizedStringDefine(@"1 day ago");
        }
...
- (NSString *)dateTimeUntilNow
{
    ...
    if (components.hour >= 6) // if more than 6 hours ago, change precision
    {
        ...
        if (diffDays == 0) // today!
        {
            ...
            {
                return kNSLocalizedStringDefine(@"This morning");
            }
            else if (startHourComponent.hour >= 12 &&
                     startHourComponent.hour < 18 &&
                     endHourComponent.hour >= 18)
            {
                return kNSLocalizedStringDefine(@"This afternoon");
            }
            return kNSLocalizedStringDefine(@"Today");
        }
        else if (diffDays == 1)
        {
            return kNSLocalizedStringDefine(@"Yesterday");
        ...
        else
        {
            ...
            if (diffWeeks == 0)
            {
                return kNSLocalizedStringDefine(@"This week");
            }
            else if (diffWeeks == 1)
            {
                return kNSLocalizedStringDefine(@"Last week");
            ...
            else
            {
                ...
                if (diffMonths == 0)
                {
                    return kNSLocalizedStringDefine(@"This month");
                }
                ...
                else
                {
                    ...
                    if (diffYears == 0)
                    {
                        return kNSLocalizedStringDefine(@"This year");
                    }
                    else if (diffYears == 1)
                    {
                        return kNSLocalizedStringDefine(@"Last year");
...
- (NSString *) stringFromFormat:(NSString *)format withValue:(NSInteger)value
{
    ...
    return [NSString stringWithFormat:kNSLocalizedStringDefine(localeFormat), value];
}
